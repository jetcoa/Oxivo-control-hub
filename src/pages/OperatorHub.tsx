      ...
      <div className="relative z-10 mx-auto max-w-7xl space-y-6">
          ...
          <div className="flex-1 overflow-y-auto rounded-md border border-white/20 relative">
            <table className="w-full text-sm">
              <thead><tr className="text-left">
                <th className="sticky top-0 z-20 bg-black/10 p-2">Name</th>
                <th className="sticky top-0 z-20 bg-black/10 p-2">Source</th>
                <th className="sticky top-0 z-20 bg-black/10 p-2">Owner / IB</th>
                <th className="sticky top-0 z-20 bg-black/10 p-2">Stage</th>
                <th className="sticky top-0 z-20 bg-black/10 p-2">Priority</th>
                <th className="sticky top-0 z-20 bg-black/10 p-2">Follow-up</th>
              </tr></thead>
              <tbody>
        ...
        <div className="premium-glass rounded-xl border border-white/20 px-5 py-4 space-y-3">
          ...
          <div className="glass-scroll max-h-[260px] overflow-y-auto rounded-md border border-white/20 relative">
            <table className="w-full text-xs md:text-sm">
              <thead><tr className="text-left">
                <th className="sticky top-0 z-20 bg-black/10 p-2">Client</th>
                <th className="sticky top-0 z-20 bg-black/10 p-2">Owner</th>
                <th className="sticky top-0 z-20 bg-black/10 p-2">Stage</th>
                <th className="sticky top-0 z-20 bg-black/10 p-2">Follow-up</th>
                <th className="sticky top-0 z-20 bg-black/10 p-2">Reactivation Priority</th>
              </tr></thead>
              <tbody>
