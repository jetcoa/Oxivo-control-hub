      ...
      <div className="relative z-10 mx-auto max-w-7xl space-y-6">
        ...
        <div className="premium-glass rounded-xl border border-white/20 px-5 py-4">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-12 md:items-center">
            ...
            <div className="md:col-span-5">
              <div className="mb-1 text-xs font-medium">Today’s progress (70% Momentum + 30% Outreach)</div>
              <div className="relative mt-6">
                <div className="pointer-events-none absolute -top-6 left-0 right-0 flex items-center justify-between">
                  <span className="rounded-md border border-[#8ea24a]/35 bg-[#2f3012]/80 px-2 py-0.5 text-xs text-[#b8d965]">
                    Momentum {momentum.momentumPercent}/70
                  </span>
                  <span className="rounded-md border border-[#8ea24a]/35 bg-[#2f3012]/80 px-2 py-0.5 text-xs text-[#e3c54d]">
                    Outreach {momentum.reachPercent}/30
                  </span>
                </div>
          ...
          <div className="flex-1 overflow-y-auto rounded-md border border-white/20 relative">
            <table className="w-full text-sm">
              <thead><tr className="text-left">
                <th className="sticky top-0 z-20 bg-[#b8d965] p-2 text-[#2f3012]">Name</th>
                <th className="sticky top-0 z-20 bg-[#b8d965] p-2 text-[#2f3012]">Source</th>
                <th className="sticky top-0 z-20 bg-[#b8d965] p-2 text-[#2f3012]">Owner / IB</th>
        ...
        <div className="premium-glass rounded-xl border border-white/20 px-5 py-4 space-y-3">
          ...
          <div className="glass-scroll max-h-[260px] overflow-y-auto rounded-md border border-white/20 relative">
            <table className="w-full text-xs md:text-sm">
              <thead><tr className="text-left">
                <th className="sticky top-0 z-20 bg-[#b8d965] p-2 text-[#2f3012]">Client</th>
                <th className="sticky top-0 z-20 bg-[#b8d965] p-2 text-[#2f3012]">Owner</th>
                <th className="sticky top-0 z-20 bg-[#b8d965] p-2 text-[#2f3012]">Stage</th>
                <th className="sticky top-0 z-20 bg-[#b8d965] p-2 text-[#2f3012]">Follow-up</th>
                <th className="sticky top-0 z-20 bg-[#b8d965] p-2 text-[#2f3012]">Reactivation Priority</th>
              </tr></thead>
              <tbody>
