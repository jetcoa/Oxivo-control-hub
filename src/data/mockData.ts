...
export const meetings: Meeting[] = [
  ...
  { id: "m3", title: "Sales Discovery — Acme Corp", date: "2026-03-30T16:00:00Z", duration_minutes: 45, duration_display: "45m", attendees: ["Frank", "Grace", "Henry (Acme)"], summary: "Acme Corp interested in enterprise plan. Key concerns: SSO integration and data residency. Follow-up demo scheduled.", action_items: [{ task: "Send pricing proposal", assignee: "Frank", done: false }, { task: "Prepare SSO demo", assignee: "Grace", done: false }], ai_insights: "High-intent prospect. 2 action items generated. Follow up within 48hrs.", meeting_type: "sales", sentiment: "positive", has_external_participants: true, external_domains: ["acme.com"], fathom_url: "https://fathom.video/demo1", share_url: "https://share.oxivo.ai/m3" },
